<template>
  <footer class="w-full my-32">
    ...
    <div class="m-auto text-gray-800 flex">
      <div class="flex-1">
        <div class="text-xs uppercase text-gray-500 font-medium">
          Koodi.info
        </div>
        <a class="my-3 block" href="/#"
          >Linkki1 <span class="text-teal-600 text-xs p-1"></span></a
        ><a class="my-3 block" href="/#"
          >Linkki2 <span class="text-teal-600 text-xs p-1"></span></a
        ><a class="my-3 block" href="/#"
          >Linkki3 <span class="text-teal-600 text-xs p-1"></span></a
        ><a class="my-3 block" href="/#"
          >Linkki4 <span class="text-teal-600 text-xs p-1"></span></a
        ><a class="my-3 block" href="/#"
          >Linkki5 <span class="text-teal-600 text-xs p-1"></span
        ></a>
      </div>
    </div>
    ...
    <div class="pt-2">
      <div
        class="flex pb-5 m-auto pt-5 border-t text-gray-800 text-sm flex-col
      md:flex-row"
      >
        <div class="mt-2">Koodi.info</div>
