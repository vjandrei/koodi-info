        ...
        <nav class="flex items-center w-full sm:items-center">
          <div class="w-3/5 mx-auto block relative">
            ...
            <div
              ...
              class="absolute shadow-lg w-full bg-white z-50 border border-gray-300 focus:outline-none focus:bg-white focus:border-gray-300 text-gray-900 rounded-lg py-4 px-8 my-2"
            >
              <g-link
          ...
          <div class="flex items-center">
            <button
              @click="toggle"
              type="button"
              class="px-2 text-gray-800 focus:outline-none focus:text-black flex items-center"
            >
