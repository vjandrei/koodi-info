    ...
    <section class="container mx-auto">
      <div class="w-full sm:w-auto p-8 xl:px-56 xl:py-16 mx-auto border-b border-gray-200 bg-white">
        <div class="text-center sm:mt-16 xl:mt-8">
          <span
            class="text-xs font-bold uppercase text-teal-700 mb-2 block"
          >{{$page.post.entry.postSubjects[0].title}}</span>
          <h1
            class="sm:text-4xl text-2xl font-bold leading-tight mt-0 mb-4 font-serif font-black"
            v-html="$page.post.entry.title"
          />
        </div>
        <div
        ...
        <div v-if="$page.post.entry.pageVideo">
          <div class="markdown">
            ...
            <iframe
              ...
              width="100%"
              height="400"
              :src="'https://www.youtube.com/embed/'+ $page.post.entry.pageVideo +'?autoplay=0&origin=http://koodi.info'"
              frameborder="0"
            ></iframe>
          </div>
        </div>
        ...
        <div v-if="$page.post.entry.postCodeLearn">
          <div class="markdown">
            ...
            <iframe
              width="100%"
              height="700"
              :src="$page.post.entry.postCodeLearn"
              frameborder="0"
              allowfullscreen
            ></iframe>
          </div>
...
export default {
  ...
  metaInfo() {
    return {
      ...
      meta: [
        {
          name: "description",
          content: this.$page.post.entry.pageSeoContent.description
        },
        { property: "og:type", content: "website" },
        {
          property: "og:title",
          content: this.$page.post.entry.pageSeoContent.social.facebook.title
        },
        {
          property: "og:description",
          content: this.$page.post.entry.pageSeoContent.social.facebook
            .description
        },
        {
          property: "og:url",
          content: "https://koodi.info/" + this.$page.post.entry.uri
        },
        {
          property: "og:image",
          content: this.$page.post.entry.pageSeoContent.social.facebook.image
            .url
        },
        { name: "twitter:card", content: "Summary" },
        {
          name: "twitter:title",
          content: this.$page.post.entry.pageSeoContent.social.twitter.title
        },
        {
        ...
        {
          name: "twitter:image",
          content: this.$page.post.entry.pageSeoContent.social.twitter.image.url
        }
      ]
    };
  },
  ...
  mounted() {
    this.postDate = this.$moment
      .unix(Number(this.$page.post.entry.postDate))
      .format("DD.MM.YYYY");
  }
};
</script>
